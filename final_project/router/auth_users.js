...
regd_users.put("/auth/review/:isbn", (req, res) => {
  ...
  return res.status(200).send(`Review for ISBN ${isbn} by user ${username} has been added/updated successfully`);
});
...
regd_users.delete("/auth/review/:isbn", (req, res) => {
  ...
  return res.status(200).send(`Review for ISBN ${isbn} by user ${username} has been deleted successfully`);
});
